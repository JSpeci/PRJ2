...
-- -----------------------------------------------------
-- Table `libtaxidb`.`DochazkaRidicu`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `libtaxidb`.`DochazkaRidicu` ;

CREATE TABLE IF NOT EXISTS `libtaxidb`.`DochazkaRidicu` (
  ...
  INDEX `fk_Dochazka_Uzivatel_idx` (`Uzivatel_idUzivatel` ASC),
